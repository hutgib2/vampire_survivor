...
class Game:
    ...
    def load_images(self):
        self.life_surf = pygame.transform.scale(pygame.image.load(join('assets', 'images', 'powerups', 'life.png')), (75, 75)).convert_alpha()
        self.pierce_surf = pygame.transform.scale(pygame.image.load(join('assets', 'images', 'powerups', 'pierce.png')), (75, 75)).convert_alpha()
        self.machinegun_surf = pygame.transform.scale(pygame.image.load(join('assets', 'images', 'powerups', 'machinegun.png')), (125, 60)).convert_alpha()
        self.lasergun_surf = pygame.transform.scale(pygame.image.load(join('assets', 'images', 'powerups', 'lasergun.png')), (100, 75)).convert_alpha()
        self.lasergun_surf = pygame.transform.flip(self.lasergun_surf, True, False)
        self.laser_surf = pygame.transform.scale(pygame.image.load(join('assets', 'images', 'powerups', 'laserbeam.png')), (WINDOW_WIDTH, 75)).convert_alpha()
        self.shotgun_surf = pygame.transform.scale(pygame.image.load(join('assets', 'images', 'powerups', 'shotgun.png')), (150, 40)).convert_alpha()
        self.gun_surf = pygame.transform.scale(pygame.image.load(join('assets', 'images', 'gun', 'gun.png')), (100, 54)).convert_alpha()
        self.knife_surf = pygame.transform.scale(pygame.image.load(join('assets', 'images', 'powerups', 'knife.png')), (150, 50)).convert_alpha()
        self.superspeed_surf = pygame.transform.scale(pygame.image.load(join('assets', 'images', 'powerups', 'superspeed.png')), (81, 81)).convert_alpha()
        self.shield_surf = pygame.transform.scale(pygame.image.load(join('assets', 'images', 'powerups', 'shield.png')), (81, 81)).convert_alpha()
        self.slow_surf = pygame.transform.scale(pygame.image.load(join('assets', 'images', 'powerups', 'snail.png')), (96, 96)).convert_alpha()
        self.aura_surf = pygame.transform.scale(pygame.image.load(join('assets', 'images', 'powerups', 'aura.png')), (800, 800)).convert_alpha()
        self.timestop_surf = pygame.transform.scale(pygame.image.load(join('assets', 'images', 'powerups', 'clock.png')), (83, 99)).convert_alpha()
        self.flamegun_surf = pygame.transform.scale(pygame.image.load(join('assets', 'images', 'powerups', 'flamegun.png')), (100, 75)).convert_alpha()
        self.mine_surf = pygame.transform.scale(pygame.image.load(join('assets', 'images', 'powerups', 'mine.png')), (92, 42)).convert_alpha()
        self.bullet_surf = pygame.transform.scale(pygame.image.load(join('assets', 'images', 'gun', 'bullet.png')), (25, 25)).convert_alpha()
        self.orb_surf = pygame.transform.scale(pygame.image.load(join('assets', 'images', 'enemies', 'orb.png')), (52, 52)).convert_alpha()
...
if __name__ == '__main__':
    ...
    home_screen_image = pygame.transform.scale(pygame.image.load(join('assets', 'images', 'home.png')), (WINDOW_WIDTH, WINDOW_HEIGHT))
    game_over_screen = pygame.transform.scale(pygame.image.load(join('assets', 'images', 'game_over.png')), (WINDOW_WIDTH, WINDOW_HEIGHT))
